        ...
        static void Main(string[] args)
        {
            ...
            switch(processOption)
            {
                case "order":
                    ...
                    new ProcessRequest().ProcessOrder(productDetail);
                    break;
                ...
                case "repair":
                    ...
                    if(productType.Equals("phone"))
                    {
                        Console.WriteLine("Please provide the phone model name");
                        productDetail = Console.ReadLine().Trim();
                        new PhoneRepair().ProcessPhoneRepair(productDetail);
                    }
                    else
                    {
                        Console.WriteLine("Please provide the accessory detail, like headphone, tempered glass");
                        productDetail = Console.ReadLine().Trim();
                        new PhoneAccesoryRepair().ProcessAccessoryRepair(productDetail);
                    }
                    break;
                default:
                    break;
